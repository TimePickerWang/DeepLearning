...
from DeepLearning.CourseFive.data_utils import *
...
def music_inference_model(LSTM_cell, densor, n_values=78, n_a=64, Ty=100):
    ...
    for t in range(Ty):
        ...
        # Select the next value according to "out", and set "x" to be the one-hot representation
        # of the selected value, which will be passed as the input to LSTM_cell on the next step.
...
def predict_and_sample(inference_model, x_initializer=x_initializer, a_initializer=a_initializer,
    ...
    """
    # Use your inference model to predict an output sequence given x_initializer,
